...
#set_app_options -name route.trace.crosstalk_driven   -value true
#set_app_options -name route.global.timing_driven     -value true

# Define the routing layers that needs to be used for routing
set_ignored_layers -max_routing_layer M3 -min_routing_layer M2
...
# Set the option to use a layer above the maximum layer as soft. 
# This sets the tool to routing above the maximum layer is discouraged, but not disallowed.
