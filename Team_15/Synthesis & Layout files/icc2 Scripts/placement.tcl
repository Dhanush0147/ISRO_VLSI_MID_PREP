...
group_path -name OUTPUTS2REG -from [all_outputs ] -to [all_registers ]
...
set_app_options -name place.coarse.congestion_driven.max_util -value 0.6
...
#Check RC delay for timings which were set during “DATA PREPARATION”
