...
create_pg_mesh_pattern P_top_two \
    -layers { \
        {horizontal_layer: M3} {width: 0.12} {spacing: interleaving} {pitch: 4.8} {offset: 1.6} {trim: true} \ 
        {vertical_layer: M2}   {width: 0.12} {spacing: interleaving} {pitch: 4.8} {offset: 1.6} {trim: true} \ 
    }
...
create_pg_vias -nets {VDD VSS} -from_layers M1 -to_layers M3 -drc no_check
